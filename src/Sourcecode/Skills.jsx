...
const Skills = () => {
  ...
  return (
    <div className='max-w-full h-screen  ml-10 ' id='skills'>
      <div className='h-10 w-full flex items-center justify-center '>
        ...
        {Expert.map(obj => (
        <div key = {obj.id} className='w-40 h-24 shadow-gray-400 shadow-lg hover:shadow-blue-400 hover:shadow-xl hover:duration-700 cursor-pointer flex items-center justify-center  bg-sky-100 '>
        ...
        <div className='mt-3 flex flex-row space-x-10'>
        {Beginner.map(obj => (
        <div key = {obj.id} className= 'w-40 h-24 shadow-gray-400 shadow-lg  cursor-pointer  flex items-center justify-center  bg-sky-100 hover:shadow-blue-400 hover:shadow-xl hover:duration-700 '>
          <img src = {obj.src} alt ="None" className='w-14 h-14'/>
          <p className='text-xs ml-1'>{obj.skillname}</p>
