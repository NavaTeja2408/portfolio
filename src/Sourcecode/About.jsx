...
const About = () => {
  return (
    <div>
        <Header />
        <div className='max-w-full md:h-screen flex md:items-center md:justify-center sm:flex-col sm:mt-20'>
            <div >
                <div className='w-full h-28 flex items-center justify-center'><h1 className='text-5xl'>About Me</h1></div>
                <div className='flex flex-row sm:flex-col  '>
                <div className='flex flex-col w-1/2 mx-auto mt-10 sm:w-4/5'>
