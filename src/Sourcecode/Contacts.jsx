    ...
    <div className="max-w-full h-screen" id="contacts">
      ...
      <div className="mt-24">
        <div className="flex flex-row mt-5 ml-5">
          ...
          <button
            className="w-10 h-10 pr-4 mr-4 bg-sky-300 hover:text-white text-2xl font-bold"
            onClick={() => {
              setToggles(!toggles);
            }}
          >
        ...
        {toggles ? (
          <div className="ml-5 mr-4 bg-gradient-to-r from-blue-300  to-sky-100 ">
            <div className="flex flex-row h-10 items-center border-4 border-sky-200">
              ...
              <Link to="https://www.linkedin.com/in/navateja-pendiala-b7b693280">
                <p className="ml-10 hover:text-white hover:cursor-pointer">
                  Pendiala Navateja
                </p>
              </Link>
            </div>
            <div className="flex flex-row h-10  items-center border-4 border-sky-200">
              ...
              <Link to="https://www.instagram.com/teja_3690?igsh=MXB3aXpwNjdyNG01ZA==">
                <p className="ml-10 hover:text-white hover:cursor-pointer">
                  @teja_3690
                </p>
              </Link>
